...
public class Main_Semana3 {
    ...
    public static void main(String[] args) {
        Participante fanMasacre1 = new FanMasacre("Pepe","Suarez","88888888",20,"nuclear",
                   0,200,150);
        Participante televidente1 = new Televidente("Juan","Lopez","77777777",13,
                   34889894,140,220);
        Participante fanMasacre2 = new FanMasacre("Luis","Torres","55555555",25,"atomico",
                120,130,200);
